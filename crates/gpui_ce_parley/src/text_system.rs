...
impl ParleyLayout {
    ...
    fn append_inline_geometry(
        ...
        if let Some(previous) = output.last_mut()
            && previous.visual_line_index == geometry.line_idx
        ...
        output.push(InlineRangeGeometry {
            ...
            visual_line_index: geometry.line_idx,
        });
    }
}
...
impl PlatformTextLayout for ParleyLayout {
    ...
    fn caret_from_pixel_point(
        ...
        let line_ix = Self::line_index_from_point(pixel_point, line_height);
    ...
    fn caret_bounds(&self, caret: CaretPosition, line_height: Pixels) -> Option<Bounds<Pixels>> {
        ...
        let line_ix = self.line_index_at_block(geometry.y0 as f32);
