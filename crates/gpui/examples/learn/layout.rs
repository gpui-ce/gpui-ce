...
use gpui::{
    Bounds, Context, Div, Hsla, IntoHsla, Render, Rgba, Window, WindowBounds, WindowOptions, div,
    prelude::*, px, size,
};
...
fn block(label: &'static str, color: Hsla, text_color: Rgba) -> Div {
    div()
        ...
        .bg(color)
        .border_1()
        .border_color(gpui::white().alpha(0.3))
        .rounded_md()
        .text_xs()
