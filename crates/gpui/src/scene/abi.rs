...
pub const SCENE_BUFFER_LAYOUTS: &[SceneBufferLayout] = &[
    ...
    layout!(Corners<ScaledPixels>, "Corners", top_left, top_right, bottom_right, bottom_left),
    ...
    layout!(Background, "Background", tag, color_space, solid, gradient_angle_or_pattern_height, colors, padding),
    layout!(AtlasTextureId, "AtlasTextureId", index, kind),
    layout!(AtlasTile, "AtlasTile", texture_id, tile_id, padding, bounds),
    layout!(TransformationMatrix, "TransformationMatrix", rotation_scale, translation),
    layout!(Quad, "Quad", order, border_style, bounds, content_mask, background, border_color, corner_radii, border_widths),
    layout!(Shadow, "Shadow", order, blur_radius, bounds, corner_radii, content_mask, color, element_bounds, element_corner_radii, inset, padding),
    layout!(Underline, "Underline", order, padding, bounds, content_mask, color, thickness, wavy),
    layout!(MonochromeSprite, "MonochromeSprite", order, padding, bounds, content_mask, color, tile, transformation),
    layout!(SubpixelSprite, "SubpixelSprite", order, padding, bounds, content_mask, color, tile, transformation),
    layout!(PolychromeSprite, "PolychromeSprite", order, padding, grayscale, opacity, bounds, content_mask, corner_radii, tile),
];
